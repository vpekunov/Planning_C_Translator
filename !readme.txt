...
3. Инсталлировать cmake
4. Инсталлировать uuid-dev
5. Инсталлировать git
6. Запустить скрипт install.sh
...
стандартными средствами Planning C.
   ...
   Размеры распараллеливаемых программ существенно ограничены возможностями GNU Prolog! Не рекомендуется
