...
1. Инсталлировать Free Pascal (fpc 3.2.0 и выше)
...
11. Установить консоли ru_RU.UTF-8, en_US.UTF-8
12. Запустить скрипт install.sh. При этом будет собран компилятор, а также автоматически скомпилированы все
