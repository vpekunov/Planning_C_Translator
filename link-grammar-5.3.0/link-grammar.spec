...
#Requires: 
BuildRequires: hunspell-devel, java-devel, jpackage-utils, libedit-devel, ant
...
%configure
CFLAGS="$RPM_OPT_FLAGS" ./configure --prefix=%{_prefix} --enable-python-bindings --disable-sat-solver --disable-aspell
