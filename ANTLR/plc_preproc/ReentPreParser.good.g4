...
prolog_predicates:
	Newline* Prolog_not? prolog_predicate prolog_if_then?
		((Semi | Comma) Newline* Prolog_not? prolog_predicates)*;
...
prolog_parameter_list:
	LeftBracket (prolog_parameter (Comma prolog_parameter)*
...
relational_expression:
	pow_expression (prolog_relation pow_expression)*;

prolog_relation:
	Equal | NotEqual | Less | Greater | LessEqual | GreaterEqual;

pow_expression:
	mul_div_expression (prolog_pow mul_div_expression)*;

prolog_pow:
	Star Star | Caret;

mul_div_expression:
	plus_min_expression (prolog_mul_div plus_min_expression)*;

prolog_mul_div:
	Star | Rem | Div_ | Mod_ | Div Div?;

plus_min_expression:
	unary_expression (prolog_plus_minus unary_expression)*;
